        ...
        public void run(String... args) {
                ...
                List<Article> articles = articleRepository.saveAll(List.of(
                                Article.builder().part("Part I").title("Article 1 — Name and Territory of the Union")
                                                ...
                                                .tags("Union,Territory").status(Article.Status.Published)
                                                .author(educator).build(),
                                ...
                                Article.builder().part("Part III").title("Article 14 — Right to Equality")
                                                ...
                                                .tags("Fundamental Rights,Equality").status(Article.Status.Published)
                                                .author(legal).build(),
                                ...
                                Article.builder().part("Part III").title("Article 19 — Freedom of Speech")
                                                ...
                                                .tags("Fundamental Rights,Freedom").status(Article.Status.Published)
                                                .author(educator).build(),
                                ...
                                Article.builder().part("Part III").title("Article 21 — Right to Life")
                                                ...
                                                .status(Article.Status.Published).author(legal).build(),
                                ...
                                Article.builder().part("Part III").title("Article 21A — Right to Education")
                                                ...
                                                .tags("Fundamental Rights,Education").status(Article.Status.Published)
                                                .author(educator).build(),
                                ...
                                Article.builder().part("Part IV-A").title("Article 51A — Fundamental Duties")
                                                ...
                                                .tags("Duties,Citizens").status(Article.Status.Draft).author(admin)
                                                .build()));
                ...
                quizRepository.saveAll(List.of(
                                QuizQuestion.builder()
                                                ...
                                                .optionC("India is not dependent on any outside power")
                                                .optionD("India has a single ruler")
                                ...
                                QuizQuestion.builder()
                                                ...
                                                .correctOption(1).category("Fundamental Rights").createdBy(educator)
                                                .build(),
                                ...
                                QuizQuestion.builder()
                                                ...
                                                .correctOption(2).category("Fundamental Rights").createdBy(educator)
                                                .build(),
